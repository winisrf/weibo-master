...
| 分支 | `main` |
| 分析提交 | `ecbe6c44801413521e5e17c0092fe482b79ae9f3`（`Initial commit`） |
| 提交时间 | 2026-07-21 09:49:40 +08:00 |
| 工程类型 | 原生 Android 单模块应用，Java + XML |
| 应用 ID | `com.gapcoder.weico` |
| 应用名称 | `weico`，登录页显示“ Weico微博” |
| 代码规模 | 56 个主代码 Java 文件，约 4699 行；44 个资源 XML，约 1703 行 |
| Android 配置 | `minSdk 23`、`targetSdk 28`、`compileSdk 28`、Java 8 |
| 后端状态 | **未包含在仓库中**；客户端默认访问本机 PHP 服务和 TCP 8888 端口 |
