...
import com.gapcoder.weico.Index.FG.AccountFragment;
import com.gapcoder.weico.Index.FG.TitleFragment;
import com.gapcoder.weico.Index.FG.WeicoFragment;
...
public class IndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentTransaction tran = fm.beginTransaction();
        hideFragments(tran);
        Fragment fg = new WeicoFragment();
        map.put(R.id.weico, fg);
        map.put(R.id.title, new TitleFragment());
        map.put(R.id.account, new AccountFragment());
    ...
    class MessageReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i("tag",""+num);
            ((WeicoFragment)map.get(R.id.weico)).message(num);
